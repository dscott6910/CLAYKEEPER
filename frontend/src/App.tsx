...
const YouthSessionSelectionPage = lazy(() =>
  import("@/features/auth/YouthSessionSelectionPage").then((module) => ({
    default: module.YouthSessionSelectionPage,
  })),
)
...
const YouthRegistrationCartPage = lazy(() =>
  import("@/features/auth/YouthRegistrationCartPage").then((module) => ({
    default: module.YouthRegistrationCartPage,
  })),
)

const ReturningShooterRegistrationPage = lazy(() =>
  import("@/features/auth/ReturningShooterRegistrationPage").then(
    (module) => ({
      default: module.ReturningShooterRegistrationPage,
    }),
  ),
)
        ...
        <AuthProvider>
          <OrganizationProvider>
            ...
            <Route
              ...
              element={
                <LazyRoute>
                  <YouthSessionSelectionPage />
                </LazyRoute>
              }
            />

            <Route
              path="/signup/:organizationSlug/youth/profile"
              element={
                <LazyRoute>
            ...
            <Route
              path="/signup/:organizationSlug/youth/cart"
              element={
                <LazyRoute>
                  <YouthRegistrationCartPage />
                </LazyRoute>
              }
            />

            <Route
              path="/signup/:organizationSlug/returning-shooter"
              element={
                <LazyRoute>
                  <ReturningShooterRegistrationPage />
                </LazyRoute>
              }
            />
