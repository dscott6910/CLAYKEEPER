...
const blankForm = (discipline = "sporting_clays"): CourseForm => ({ id: null, name: "East Course", discipline, courseSide: "East", templateName: "", stationCount: MAX_STATIONS_PER_COURSE, stations: blankStations() })
  ...
  return <PageContainer><div className="space-y-6">
    ...
    <section className="grid gap-6 xl:grid-cols-[280px_minmax(0,1fr)]">
      ...
      <main className="space-y-5">
        <section className="rounded-2xl border bg-white p-5 shadow-sm"><div className="grid gap-4 md:grid-cols-2 xl:grid-cols-5">
