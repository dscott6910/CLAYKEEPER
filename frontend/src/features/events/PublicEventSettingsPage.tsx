...
export function PublicEventSettingsPage() {
  ...
  return <PageContainer><div className="space-y-6">
    ...
    <section className="grid gap-4 md:grid-cols-2"><Toggle label="Show live scores" detail="Display draft and finalized digital scorecards as they arrive." value={showLiveScores} setValue={setShowLiveScores} /><Toggle label="Show squad details" detail="Display squad, post, course, and start-time information." value={showSquads} setValue={setShowSquads} /><Toggle label="Show team standings" detail="Display team totals using the top five visible participants." value={showTeams} setValue={setShowTeams} /><Toggle label="Show published awards" detail="Display official results after awards are published." value={showAwards} setValue={setShowAwards} /><Toggle label="Enable clubhouse display" detail="Allow the large-screen display-mode URL." value={displayModeEnabled} setValue={setDisplayModeEnabled} /></section>
