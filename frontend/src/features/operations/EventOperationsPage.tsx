    ...
    <div className="space-y-6 p-4 md:p-6">
      <section className="rounded-2xl bg-slate-950 p-6 text-white shadow-sm">
        <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
          <div><p className="text-sm font-semibold uppercase tracking-[.18em] text-emerald-400">Live operations</p><h2 className="mt-2 text-3xl font-bold">{snapshot?.selectedEvent?.name ?? "Select an event"}</h2><p className="mt-2 text-sm text-slate-400">One screen for tournament readiness, squad and post activity, scoring, awards, and payments.</p></div>
