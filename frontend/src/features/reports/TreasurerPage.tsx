...
export function TreasurerPage() {
  ...
  function exportCsv() {
    const headers = ["Event", "Date", "Participant", "Participant Number", "Team", "Class", "Shoots", "Payment Status", "Payment Method", "Source", "Event Fee", "Shoot Fees", "Organization Fees", "Adjustments", "Expected", "Paid", "Balance"]
