-- Fix ambiguous updated_at reference in atomic digital scoring.
--
-- The function returns an output column named updated_at, which conflicts
-- with the unqualified digital_scorecards.updated_at reference used by the
